...
GHOST_COLORS.append(formatColor(.5, 0.2, 0.51))
GHOST_COLORS.append(formatColor(.6, 0.3, 0.61))
GHOST_COLORS.append(formatColor(.7, 0.4, 0.71))
GHOST_COLORS.append(formatColor(.8, 0.5, 0.81))
GHOST_COLORS.append(formatColor(.9, 0.6, 0.91))
...
class PacmanGraphics:
    ...
    def drawStaticObjects(self, state):
        ...
        self.goals = self.draw_goals(layout.goals)
        refresh()
    ...
    def draw_goals(self, goals):
        goalImages = {}
        for goal in goals:
            (screen_x, screen_y) = self.to_screen(goal)
            dot = circle((screen_x, screen_y),
                         GOAL_SIZE * self.gridSize,
                         outlineColor=GOAL_COLOR,
